...
<?= $this->section('content') ?>
    ...
    <form method="POST" action="<?= base_url('docente/asignaturas') ?>" enctype="multipart/form-data">
        <?= csrf_field() ?>

        <div class="card primary">
            <div class="card-header">
                <h5 class="card-title">Crear asignatura</h5>
                <a href="<?= base_url('docente/asignaturas') ?>" class="btn btn-danger float-right">Cancelar y regresar</a>
            </div>
