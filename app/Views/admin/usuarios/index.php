                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="<?= base_url('admin/usuarios/'.$usuario['id']) ?>" class="btn btn-default" title="Ver"><i class="fas fa-eye"></i></a>
                                            <a href="<?= base_url('admin/usuarios/'.$usuario['id'].'/edit') ?>" class="btn btn-default" title="Editar"><i class="fas fa-edit"></i></a>
                                            <form class="" method="post" action="<?= base_url('admin/usuarios/'.$usuario['id'])?>" id="usuarioDeleteForm<?=$usuario['id']?>">
                                                <input type="hidden" name="_method" value="DELETE"/>
                                                <a href="javascript:void(0)" onclick="deleteUsuario('usuarioDeleteForm<?=$usuario['id']?>')" class="btn btn-default" title="Eliminar"><i class="fas fa-trash text-red"></i></a>
                                            </form>
                                        </div>
                                    </td>
                                </tr>
