...
$this->section('encabezado') ?><p class="text-uppercase">Editar datos de la carrera seleccionada</p><?= $this->endSection();
?>
    ...
    <div class="">
        ...
        <div class="row py-4">
            <div class="col-xl-12 text-end">
                <a href="<?= base_url('admin/carreras') ?>" class="btn btn-danger">Cancelar y regresar</a>
            </div>
        </div>
    </div>


    <form method="POST" action="<?= base_url('admin/carreras/' . $carrera['id']); ?>" enctype="multipart/form-data">
        <?= csrf_field() ?>

        <div class="card primary">
            <div class="card-header">
                <h5 class="card-title">Actualizar datos de la carrera</h5>
            </div>
                    ...
                    <div class="col">
                        <div class="form-group mb-3 has-validation">
                            ...
                            <input type="text"
                                   ...
                                   name="nombre"
                                   value="<?php if ($carrera['nombre']): echo $carrera['nombre']; else: set_value('nombre'); endif; ?>"/>
