        ...
        <div class="card primary">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group mb-3 has-validation">
                            <label class="form-label">Clave de la grupo:</label>
                            <input type="text"
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <textarea
                                ...
                                name="descripcion" placeholder="Resumen de la grupo"><?php echo set_value('descripcion'); ?></textarea>
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            <label class="form-label">Temario de la grupo:</label>
                            <textarea
                                class="form-control <?php if ($validation->getError('temario')): ?>is-invalid<?php endif ?>"
                                name="temario" placeholder="Temario de la grupo"><?php echo set_value('temario'); ?></textarea>
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group mb-3 has-validation">
                            <label class="form-label">Archivo del temario de la grupo:</label>
                            <input type="file" accept="application/pdf"
                                   class="form-control <?php if ($validation->getError('temarioArchivo')): ?>is-invalid<?php endif ?>"
                                   name="temarioArchivo" placeholder="Temario de la grupo" value="<?php echo set_value('temarioArchivo'); ?>"/>
